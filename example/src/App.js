      ...
      <div className='mainpage'>
        ...
        <img src={logo} alt="Logo" />
          ...
          <div className='link__links'>
            <ul>
              <li className='active_110'><a href="/"><img src={iconleft} alt="iconleft" /></a></li>
              <li><a href="/createobs"><img src={iconleft2} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft3} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft4} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft5} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft6} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft7} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft8} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft9} alt="iconleft" /></a></li>
              <li><a href="#"><img src={iconleft10} alt="iconleft" /></a></li>
